...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vs(e,t,n){let r=new Float32Array(is),i=new G(0,1,0);return new _a({name:`SphericalGaussianBlur`,defines:{n:is,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ys(){return new _a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(){return new _a({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xs(),fragmentShader:`
